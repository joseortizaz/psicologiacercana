...
export default async function AssistantHomePage() {
  ...
  // RLS ya limita estas consultas a la organización/clínica del usuario
  // autenticado — no hace falta filtrar por clinic_id explícitamente.
  const { data: upcoming } = await supabase
    .from("appointments")
    .select(
      "id, start_time, end_time, status, patient:patients(id, full_name), therapist:profiles!appointments_therapist_id_fkey(full_name)",
    )
